...
public class GenomicRangeQuery {
    ...
    public static void validRangeTest() {
        GenomicRange gen = new GenomicRange();
        int[] result = gen.solveGenomicRange("GACACCATA", new int[]{0, 0, 4, 7}, new int[]{8, 2, 5, 7});
...
class GenomicRange {
    ...
    public int[] solveGenomicRange(String S, int[] P, int[] Q) {
        ...
        for (int i=0; i<S.length(); i++) {
            ...
            // To learn what's prefix sums look at here https://codility.com/media/train/3-PrefixSums.pdf
